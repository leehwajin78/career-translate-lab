...
| 요소 | 상세 |
|------|------|
| 상단 헤드라인 | "내 경력의 진짜 가치를 증명할 나만의 한 문장을 찾아서" (Bold, 큰 사이즈) |
| 서브텍스트 | "단 7개의 질문으로 내 경력의 빛나는 순간과 숨겨진 핵심 자산을 진단해 보세요." |
...
- 헤드라인: "내 경력의 진짜 가치를 증명할 나만의 한 문장을 찾아서" (Bold, text-3xl md:text-5xl)
- 서브: "단 7개의 질문으로 내 경력의 빛나는 순간과 숨겨진 핵심 자산을 진단해 보세요."
