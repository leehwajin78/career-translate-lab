      ...
      <section className="bg-white">
        <div className="container-prose pt-20 md:pt-28 pb-16 md:pb-24 text-center">
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
            <CTAButton href="/diagnosis" variant="primary" className="w-full sm:w-auto justify-center">경력 가치 무료 진단받기 →</CTAButton>
            <CTAButton href="/consultation" variant="ghost" className="w-full sm:w-auto justify-center">30분 무료 상담 신청하기</CTAButton>
            <a
        ...
        <div className="container-prose">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-6">
            <div className="bg-background border border-border p-8 rounded-2xl shadow-sm flex flex-col">
              ...
              <Link href="/diagnosis" className="w-full py-3 rounded-xl font-bold bg-accent text-white text-center text-sm hover:bg-accent/90 transition-colors">무료 진단 시작하기</Link>
            </div>
            <div className="bg-background border border-border p-8 rounded-2xl shadow-sm flex flex-col">
              <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center mb-6">
              ...
              <Link href="/consultation" className="w-full py-3 rounded-xl font-bold bg-primary text-white text-center text-sm hover:bg-primary/90 transition-colors">무료 상담 신청하기</Link>
            </div>
            <div className="bg-primary text-white p-8 rounded-2xl shadow-xl flex flex-col">
              ...
              <Link href="/apply/diagnosis" className="w-full py-3 rounded-xl font-bold bg-white text-primary text-center text-sm hover:bg-white/90 transition-colors">한끗 진단 신청하기</Link>
            </div>
          </div>
          ...
          <div className="max-w-2xl mx-auto space-y-3">
            {[
              ...
              <details key={idx} className="border border-border rounded-xl overflow-hidden">
                <summary className="p-5 cursor-pointer font-bold text-foreground text-base hover:bg-secondary/40 transition-colors list-none flex justify-between items-center [&::-webkit-details-marker]:hidden">
                  {item.q}
      ...
      <section className="py-12 md:py-16 bg-primary text-primary-foreground text-center">
        <div className="container-prose">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <Link href="/diagnosis" className="w-full sm:w-auto bg-transparent text-white border-2 border-white px-8 py-3.5 rounded-full font-bold text-base hover:bg-white/10 transition-all">
              경력 가치 무료 진단받기
            </Link>
            <Link href="/consultation" className="w-full sm:w-auto bg-white text-primary px-8 py-3.5 rounded-full font-bold text-base hover:bg-white/90 transition-all">
              30분 무료 상담 신청하기
            </Link>
          </div>
        </div>
