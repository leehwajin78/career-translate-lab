      ...
      <div className="bg-white">
        <div className="container-prose py-20 md:py-24 text-center">
          ...
          <div className="mt-7 flex gap-3 justify-center flex-wrap">
            <Link to="/diagnosis" className={btnPrimary}>경력 가치 무료 진단받기 →</Link>
            <Link to="/consultation" className={btnGhost}>30분 무료 상담 신청하기</Link>
          </div>
        ...
        <div className="container-prose py-16 text-center">
          ...
          <div className="mt-6 grid grid-cols-[1fr_auto_1fr] gap-4 md:gap-6 items-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div className="bg-primary text-white font-extrabold text-xs md:text-sm px-4 py-2 rounded-full whitespace-nowrap">한끗프로젝트</div>
              <span className="text-xl text-primary">→</span>
            </div>
            <div className="bg-primary rounded-xl p-5 md:p-6 text-left">
              <div className="font-extrabold text-white text-base md:text-lg mb-3">시장이 선택하는 자산</div>
              <ul className="space-y-1.5 text-white/85 text-sm font-medium">
                <li>· 전문가 강의안</li>
                <li>· 대표 경력서</li>
                <li>· B2B 제안서</li>
              </ul>
