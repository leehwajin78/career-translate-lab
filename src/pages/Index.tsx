...
import { ArrowRight, ArrowRightLeft, AlertTriangle, Sparkles, Check, Clock, User, Briefcase } from "lucide-react";
          ...
          <div className="mt-16 relative max-w-5xl mx-auto">
            <div className="grid md:grid-cols-[1fr_auto_1fr] gap-6 items-center">
              ...
              <div className="bg-background border border-border p-8 md:p-10 rounded-2xl shadow-sm relative text-left h-full flex flex-col justify-center">
                <h3 className="font-serif text-xl text-primary mb-6">당신의 30년 경력</h3>
              ...
              <div className="bg-primary text-primary-foreground p-8 md:p-10 rounded-2xl shadow-xl relative text-left h-full transform md:scale-105 transition-transform border border-primary-foreground/10 flex flex-col justify-center">
                <h3 className="font-serif text-xl mb-6 text-white">시장이 선택하는 자산</h3>
                <ul className="space-y-5 text-base text-primary-foreground/90 font-medium">
                  <li className="flex items-center gap-3"><Check size={20} className="text-accent shrink-0" /> 전문가 프로필 1페이지</li>
                  <li className="flex items-center gap-3"><Check size={20} className="text-accent shrink-0" /> B2B 제안서 템플릿</li>
                  <li className="flex items-center gap-3"><Check size={20} className="text-accent shrink-0" /> 대표 강의안 (60분)</li>
                  <li className="flex items-center gap-3"><Check size={20} className="text-accent shrink-0" /> 채널 진입 전략 가이드</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container-prose text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center bg-background p-8 rounded-2xl border border-border shadow-sm">
              ...
              <p className="text-foreground/70 text-sm leading-relaxed">여러 수강생 중 한 명이 아닙니다.<br />대표님만을 위한 전담 매니저가<br />과정 내내 밀착 관리합니다.</p>
            </div>
            <div className="flex flex-col items-center bg-background p-8 rounded-2xl border border-border shadow-sm">
              ...
              <h3 className="font-bold text-primary text-lg mb-3">장기적으로 활용 가능한 자산</h3>
              <p className="text-foreground/70 text-sm leading-relaxed">완성된 자산은 강의, 자문, 제안 등<br />다양한 기회에 반복적으로<br />활용할 수 있습니다.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 bg-primary text-white">
        <div className="container-prose text-center">
          ...
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-16">
            강사 양성 과정도, 일반 브랜딩 컨설팅도 아닙니다.<br />
            경력을 시장이 선택하는 자산으로 만드는 서비스입니다.
          </p>
          <div className="max-w-4xl mx-auto bg-white/10 rounded-3xl border border-white/20 overflow-hidden text-white">
            <div className="grid grid-cols-3 p-6 border-b border-white/10 font-bold text-center">
              <div>구분</div>
              <div>일반 브랜딩 학원</div>
              <div className="text-lg">한끗프로젝트</div>
            </div>
            ...
            <div className="grid grid-cols-3 p-6 border-b border-white/10 text-sm text-center items-center">
              ...
              <div>불특정 다수</div>
              <div className="font-bold">시니어 경력자 전담</div>
            </div>
      ...
      <section className="py-24">
        <div className="container-prose">
          <div className="text-center mb-6">
            ...
            <p className="mt-4 text-foreground/70 text-lg max-w-2xl mx-auto mb-16">
              처음부터 큰 결정을 내릴 필요 없습니다.<br />
              진단으로 방향을 확인하고, 필요한 단계까지 이어가면 됩니다.
            </p>
          </div>
        ...
        <div className="container-prose text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            <div className="bg-background border border-border p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="font-serif text-lg text-primary mb-3">전문가 프로필 1페이지</h3>
              <p className="text-foreground/70 text-sm leading-relaxed break-keep">"이 분이 누구인지" 한눈에 보여주는 소개 카드. 미팅 자리에서 바로 건넬 수 있습니다.</p>
            </div>
            <div className="bg-background border border-border p-8 rounded-2xl shadow-sm">
              <Briefcase className="text-accent mb-6" size={32} />
              <h3 className="font-serif text-lg text-primary mb-3">B2B 제안서 템플릿</h3>
            ...
            <div className="bg-background border border-border p-8 rounded-2xl shadow-sm">
              ...
              <h3 className="font-serif text-lg text-primary mb-3">대표 강의안 (60분)</h3>
              <p className="text-foreground/70 text-sm leading-relaxed break-keep">기업 특강, 세미나에 바로 쓸 수 있는 시그니처 강의 슬라이드입니다.</p>
            </div>
            <div className="bg-background border border-border p-8 rounded-2xl shadow-sm">
              <Check className="text-accent mb-6" size={32} />
              <h3 className="font-serif text-lg text-primary mb-3">채널 진입 전략 가이드</h3>
              <p className="text-foreground/70 text-sm leading-relaxed break-keep">어떤 채널에서, 어떤 방식으로 시작할지 실행 가능한 전략을 정리해 드립니다.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-prose text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto text-left">
            ...
            <div className="bg-background border-2 border-accent p-6 md:p-8 pt-10 rounded-3xl shadow-lg flex flex-col relative">
              ...
              <p className="text-primary font-serif text-xl md:text-2xl font-bold mb-2">한끗 진단</p>
              <p className="text-foreground/70 text-xs mb-4 break-keep">내 경력의 시장 가치를 진단합니다</p>
              <div className="mb-4 flex items-baseline gap-1">
                <span className="text-2xl md:text-3xl font-serif font-bold text-primary tracking-tight">500,000</span>
            ...
            <div className="bg-background border border-border p-6 md:p-8 rounded-3xl shadow-sm flex flex-col">
              ...
              <p className="text-primary font-serif text-xl md:text-2xl font-bold mb-2">한끗 빌드</p>
              <p className="text-foreground/70 text-xs mb-4 break-keep">강의안·프로필·제안서를 완성합니다</p>
              <div className="mb-4 flex items-baseline gap-1">
                <span className="text-2xl md:text-3xl font-serif font-bold text-primary tracking-tight">3,500,000</span>
                <span className="text-xs text-foreground/70 font-medium">원</span>
              </div>
            ...
            <div className="bg-background border border-border p-6 md:p-8 rounded-3xl shadow-sm flex flex-col">
              ...
              <p className="text-primary font-serif text-xl md:text-2xl font-bold mb-2">한끗 론칭</p>
              <p className="text-foreground/70 text-xs mb-4 break-keep">실제 무대와 수익 기회에 접근하도록 지원합니다</p>
              <div className="mb-4 flex items-baseline gap-1">
                <span className="text-2xl md:text-3xl font-serif font-bold text-primary tracking-tight">7,000,000</span>
                <span className="text-xs text-foreground/70 font-medium">원</span>
              </div>
            ...
            <div className="bg-background border border-border p-6 md:p-8 rounded-3xl shadow-sm flex flex-col">
              ...
              <p className="text-primary font-serif text-xl md:text-2xl font-bold mb-2">한끗 파트너</p>
