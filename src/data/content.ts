...
export const FAQS = [
  {
    ...
    answer: "가능합니다. 오히려 목표가 흐릿한 분일수록 경력 진단과 방향 정리가 먼저 필요합니다."
  },
  {
    question: "Q2. 단순한 AI 분석인가요?",
    answer: "아닙니다. AI는 42문항의 심층 인터뷰를 돕는 도구일 뿐, 실제 브랜드 설계와 매니지먼트는 전문 코치가 밀착하여 진행합니다."
  },
  {
    question: "Q3. 퇴직 전에도 받을 수 있나요?",
    answer: "네, 퇴직 1~2년 전이 가장 적기입니다. 회사 안에서 안전하게 넥스트 챕터를 준비할 수 있도록 돕습니다."
  },
  {
    question: "Q4. 결과물은 어디에 활용할 수 있나요?",
    answer: "도출된 브랜드 프로필과 제안서는 강연, 자문, 컨설팅 등 B2B 시장에서 즉시 수익을 창출하는 핵심 무기로 활용됩니다."
  },
  {
    question: "Q5. 제 경력이 특별하지 않아도 괜찮나요?",
    answer: "20년 이상의 꾸준한 실무 경험 그 자체가 이미 훌륭한 자산입니다. 저희는 그 안에 숨겨진 진짜 가치를 시장의 언어로 번역해 드립니다."
  },
  {
    question: "Q6. 바로 수익이 생기나요?",
    answer: "본 과정은 수익 창출을 위한 '무기(자산)'를 만드는 데 집중합니다. 이후 매니지먼트 옵션을 통해 실제 무대 연결과 수주를 지원해 드립니다."
  }
];
