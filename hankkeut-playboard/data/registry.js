...
(function () {
  ...
  var workItems = [
    ...
    w('WI-10', 'AI 자동 초안 (Claude claude-opus-4-8, 코치 트리거)', 'p1-remaining', 'done', 'CHG-028', ['WI-09'], ['system/coaching-analyzing', 'operator/workspace'],
      '서버 전용 coachingAI(import "server-only") + 강제 tool_use → 8대 브랜드 프로필 초안, ANTHROPIC_API_KEY 미설정 시 Mock 폴백. saveAnalysis($transaction, status=analyzed) + A-03 "AI 초안 생성" 버튼. vitest 3 (총 25), build green. ISSUE-05 해결'),
